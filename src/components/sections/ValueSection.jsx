    ...
    <section className="section-shell">
      <div className="site-container">
        <div className="glass-panel relative overflow-hidden px-6 py-10 sm:px-10 sm:py-12">
          <div className="absolute -left-20 top-0 h-52 w-52 rounded-full bg-brand-100/70 blur-3xl" />
          <div className="absolute -right-12 bottom-0 h-44 w-44 rounded-full bg-cyan-100 blur-3xl" />
          <div className="relative grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {points.map((point) => (
                <article key={point.title} className="hover-lift rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_16px_45px_rgba(15,23,42,0.07)] backdrop-blur">
