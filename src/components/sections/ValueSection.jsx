		...
		<section id="why-us" className="section-shell">
			<Container>
				<GlassCard className="relative overflow-hidden px-6 py-10 sm:px-10 sm:py-12">
					...
					<div className="absolute -right-12 bottom-0 h-44 w-44 rounded-full bg-[#ffb300]/14 blur-3xl" />
					...
					<div className="relative grid gap-10 lg:grid-cols-2 lg:items-start">
						...
						<div className="grid gap-6 md:grid-cols-2">
							{points.map((point) => (
								...
								>
									<div className="h-1.5 w-14 rounded-full bg-linear-to-r from-[#0a7cff] to-[#ffb300]" />
