					...
					<GlassCard className="overflow-hidden p-8 sm:p-10">
						...
						<div className="mt-8 space-y-4">
							<div className="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-lg">
								...
								<a
									className="mt-2 inline-block text-base font-semibold text-white transition hover:text-[#e7d7b8]"
							...
							<div className="rounded-2xl border border-white/10 bg-linear-to-br from-[#7d8794]/15 to-[#c7a56b]/10 p-5 shadow-lg">
							...
							<div className="rounded-2xl border border-[#c7a56b]/20 bg-[#c7a56b]/10 p-5 text-sm text-[#e7d7b8] shadow-lg">
								<p className="font-semibold text-[#f3ead8]">What happens next?</p>
								<p className="mt-2 leading-7 text-[#e7d7b8]/75">
						...
						<form className="space-y-6" onSubmit={handleSubmit}>
							...
							<div className="grid gap-6 sm:grid-cols-2">
								<label className="block text-sm font-medium text-white/70">
									Name
									<input
										className="mt-2 w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-base text-white outline-none transition placeholder:text-white/30 focus:border-[#c7a56b]/30"
										name="name"
							...
							<div className="grid gap-6 sm:grid-cols-2">
								...
								<label className="block text-sm font-medium text-white/70">
									Project type
									<select
										className="mt-2 w-full rounded-2xl border border-white/10 bg-[#17191d] px-4 py-3 text-base text-white outline-none transition focus:border-[#c7a56b]/30"
										name="projectType"
										onChange={handleChange}
							...
							<label className="block text-sm font-medium text-white/70">
								...
								<textarea
									className="mt-2 min-h-40 w-full rounded-3xl border border-white/10 bg-white/5 px-4 py-3 text-base text-white outline-none transition placeholder:text-white/30 focus:border-[#c7a56b]/30"
									name="message"
									onChange={handleChange}
