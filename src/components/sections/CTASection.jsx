  ...
  return (
    <section className="section-shell">
      <div className="site-container">
        <div className="relative overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#0b1328_0%,#17315f_22%,#2f6fe4_55%,#2fd7e6_100%)] px-6 py-12 text-white shadow-[0_30px_80px_rgba(11,19,40,0.38)] sm:px-10 sm:py-14 lg:flex lg:items-center lg:justify-between lg:gap-10">
