...
export default function CTASection({ content }) {
	return (
		<section className="py-20 sm:py-24">
			<Container>
				<div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-950 via-blue-900 to-cyan-500 px-6 py-12 text-white shadow-2xl sm:px-10 sm:py-14 lg:flex lg:items-center lg:justify-between lg:gap-10">
