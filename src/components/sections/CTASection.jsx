...
export default function CTASection({ content }) {
	return (
		<section className="section-shell">
			<Container>
				<div className="relative overflow-hidden rounded-3xl border border-[#18d7ff]/10 bg-linear-to-br from-[#07111f] via-[#0a1f3d] via-[55%] to-[#102e58] px-6 py-12 text-white shadow-2xl sm:px-10 sm:py-14 lg:flex lg:items-center lg:justify-between lg:gap-10">
