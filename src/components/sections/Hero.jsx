...
export default function Hero({ content }) {
	return (
		<section className="relative overflow-hidden pb-8 pt-8 sm:pb-10 sm:pt-10" id="top">
			<div className="pointer-events-none absolute inset-x-0 top-0 h-[34rem] bg-linear-to-b from-white/6 via-transparent to-transparent" />
			...
			<Container>
				<div className="mx-auto max-w-5xl text-center">
					...
					<h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-7xl lg:leading-[0.95]">
			...
			<div className="relative mt-10 sm:mt-12">
				...
				<div className="pointer-events-none absolute left-[8%] top-14 hidden rotate-[-6deg] lg:block">
					<div className="chip">Mobile-friendly layouts</div>
				</div>
				<div className="pointer-events-none absolute right-[9%] top-24 hidden rotate-[6deg] lg:block">
				...
				<div className="mx-auto w-[min(1480px,calc(100%-1rem))] sm:w-[min(1480px,calc(100%-2.5rem))]">
					<div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/85 p-3 shadow-[0_30px_80px_rgba(2,8,23,0.40)] backdrop-blur-xl sm:p-5 lg:p-6">
						...
						<div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-slate-900 shadow-2xl">
							<img
						...
						<div className="pointer-events-none absolute left-6 top-24 hidden rounded-2xl border border-white/10 bg-slate-950/80 px-4 py-3 text-sm text-white/75 backdrop-blur lg:block">
							...
							<p className="mt-1 text-white/60">Refresh outdated websites into something sharper.</p>
						</div>
						...
						<div className="pointer-events-none absolute bottom-6 right-6 hidden rounded-2xl border border-amber-300/20 bg-amber-300/10 px-4 py-3 text-sm text-amber-100 backdrop-blur lg:block">
							...
							<p className="mt-1 text-amber-100/70">Built to feel polished across desktop and mobile.</p>
						</div>
					</div>
				</div>
			</div>
