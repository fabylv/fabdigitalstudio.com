			...
			<Container>
				<div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.95fr)] lg:gap-10">
					...
					<div className="relative">
						<div className="pointer-events-none absolute inset-x-0 top-10 h-40 bg-radial from-cyan-400/14 to-transparent blur-3xl" />
						<div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/85 p-3 shadow-[0_30px_80px_rgba(2,8,23,0.40)] backdrop-blur-xl sm:p-4 lg:p-5">
							...
							<div className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-slate-900 shadow-2xl">
								<img
							...
							<div className="mt-4 grid gap-3 sm:grid-cols-2">
								...
								<div className="rounded-2xl border border-amber-300/20 bg-amber-300/10 p-4 backdrop-blur-xl">
									<p className="text-sm font-semibold text-amber-100">Better balance</p>
